...
public class teacherManage extends JDialog{
    ...
    JLabel jl2=new JLabel("教师名:");
    JLabel jl3=new JLabel("性别:");
    JLabel jl4=new JLabel("年龄：");
    JLabel jl5=new JLabel("工龄：");
    ...
    public teacherManage() throws Exception {
        checkdata();
        init();
        mouseAction();
    }
    ...
    public void checkdata() throws SQLException {
        ...
        {  //教师五项参数
            ...
            r.add(rs.getString("教师名"));
            r.add(rs.getString("性别"));
            r.add(rs.getString("年龄"));
            r.add(rs.getString("工龄"));
            data.add(r);
        }
        table.updateUI();
    }
    ...
    public void insert() throws SQLException {
        String sql = "INSERT INTO TEACHER(教师号,教师名,性别,年龄,工龄) "+ "VALUES(?,?,?,?,?)";
        ...
        st.setInt(5, Integer.parseInt(jt5.getText()));
        st.executeUpdate();
        checkdata();
    ...
    public void modify() throws SQLException {
        String sql = "update TEACHER set 教师号=?,教师名=?,性别=?,年龄=?,工龄=? where 教师号 = ?";
        PreparedStatement st = conn.prepareStatement(sql);
        st.setString(1, jt1.getText());
        st.setString(2, jt2.getText());
        st.setString(3, jt3.getText());
    ...
    public void delete() throws SQLException {
        String sql = "delete from TEACHER where 教师号 = ?";
        PreparedStatement st = conn.prepareStatement(sql);
        st.setString(1, jt1.getText());
        st.executeUpdate();
        checkdata();
    ...
    public void mouseAction(){
        jb1.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if(jt1.getText().length()!=5||jt2.getText().length()==0||(!jt3.getText().equals("男")&&!jt3.getText().equals("女"))){
        ...
        jb2.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                new warnView("无法找到对应的教师，请重新输入");//操作不合法
        ...
        jb3.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                new warnView("要删除的教师号不存在，请重新输入");//操作不合法
            }
        });
    }
}
